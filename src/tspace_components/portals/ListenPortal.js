...
const createRippleMaterial = () => {
  ...
  const imageTexture = textureLoader.load(process.env.PUBLIC_URL + '/assets/audioIcon.png');
...
const planeTexture = new THREE.TextureLoader().load(process.env.PUBLIC_URL + '/assets/UI/Music3.png');
