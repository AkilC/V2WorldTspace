...
const createRippleMaterial = () => {
  ...
  const imageTexture = textureLoader.load(process.env.PUBLIC_URL + '/assets/imageIcon.png');
...
const planeTexture = new THREE.TextureLoader().load(process.env.PUBLIC_URL + '/assets/UI/Gallery2.png');
